...
import 'package:maestro_builder/src/writer/access_writer.dart';
import 'package:maestro_builder/src/writer/route_writer.dart';
import 'package:maestro_builder/src/writer/slice_writer.dart';
import 'package:maestro_builder/src/writer/title_writer.dart';
import 'package:maestro_builder/src/writer/use_case_writer.dart';
...
class ProcessedFramework {
  ...
  String write() {
    ...
    builder..body.addAll([
      ...
      TitleWriter( 'Maestro Slice IDs' ).write(),
      SliceWriter( modules.map((e) => e.slices).reduce((value, element) => [
        ...value,
        ...element,
      ]).toList() ).write(),
    ]);
